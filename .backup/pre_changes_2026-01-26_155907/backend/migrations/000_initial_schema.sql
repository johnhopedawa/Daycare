...
CREATE TABLE IF NOT EXISTS users (
  ...
  annual_sick_days INTEGER DEFAULT 0,
  annual_vacation_days INTEGER DEFAULT 0,
  sick_days_remaining DECIMAL(5,2) DEFAULT 0,
  vacation_days_remaining DECIMAL(5,2) DEFAULT 0,
